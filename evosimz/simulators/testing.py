...
test0_lg = tree.QuartetTreeSubsampler(
    base_simulator=tree.TreeSimulator(
        taxon_count_model=scipy.stats.uniform(4, 1),
        internal_branch_model=scipy.stats.uniform(0.4, 0.1),
        external_branch_model=scipy.stats.uniform(0.4, 0.1),
        sequence_simulator=sequence.HeterogeneousProteinSequenceSimulator(
            site_count_range=(3000, 3001),
