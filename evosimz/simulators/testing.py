...
test0_lg = tree.QuartetTreeSubsampler(
    base_simulator=tree.TreeSimulator(
        taxon_count_model=scipy.stats.uniform(10, 10),
        internal_branch_model=scipy.stats.uniform(0.1, 0.1),
        external_branch_model=scipy.stats.uniform(0.1, 0.1),
        sequence_simulator=sequence.HeterogeneousProteinSequenceSimulator(
            site_count_range=(1000, 2001),
